# chemical-space — combinatorial-random-space

输入：`{"chain_length": 100, "copolymer": "random", "max_distinct_monomers": 2, "monomers": 10, "primary_dataset": "PI1M", "stoichiometry": "1,1"}`
...
| 结果 | 值 |
| --- | ---: |
| sequence_count | 10,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000,000 |
| log10_sequence_count | 100 |
| synthesizable_count | 57,044,277,010,270,323,067,351,644,241,840 |
| synthesizable_fraction | 5.70443e-69 |
| composition_constrained_sequence_count | 100,891,344,545,564,193,334,812,497,256 |
| known_library | `"PI1M"` |
| known_library_size | 1,000,000 |
| coverage_of_known_library | 1e-94 |
| log10_sequence_count_per_known_entry | 94 |
...
| --- | --- | --- | --- | --- |
| `"PI1M"` | 1,000,000 | 1e-94 | 94 | `"reported"` |
| `"PoLyInfo"` | 12,000 | 1.2e-96 | 95.9208 | `"reported"` |
| `"POINT2"` | 238,219 | 2.38219e-95 | 94.623 | `"reported"` |
| `"polyBERT pretraining"` | 100,000,000 | 1e-92 | 92 | `"reported"` |
