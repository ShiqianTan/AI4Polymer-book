...
输入：`{"atoms": 100, "bonds": 105, "device": "a100-80gb-sxm", "edge_features": 32, "efficiency": 0.3, "ffn_multiplier": 4, "heads": 8, "hidden": 256, "layers": 4, "num_atom_types": 32, "num_bond_types": 8, "readout": "sum"}`
...
| total_flops | 327,258,624 |
| parameters | 1,948,417 |
| aggregation_scalar_adds | 26,880 |
| readout_scalar_adds | 25,600 |
| flops_per_parameter | 167.961 |
| transformer_parameters | 3,233,280 |
| transformer_forward_flops | 670,237,184 |
| inference_seconds | 3.49635e-06 |
| inference_energy_estimate | 0.00139854 |
